...
* 'configure.py --minimized-build --cc=msvc --os=windows --amalgamation --single-amalgamation-file --disable-shared-library --enable-modules=cryptobox,auto_rng,entropy'
*
* Target
